        ...
        <Card className='w-full shadow-lg border border-border/80 bg-card/60 backdrop-blur-md rounded-2xl overflow-hidden'>
          ...
          <CardContent>
              ...
              <div className='text-center py-4 space-y-5 animate-scale-up'>
                ...
                <div className='space-y-2'>
                  ...
                  <p className='text-xs text-muted-foreground pt-1 leading-relaxed'>
                    Vui lòng kiểm tra hộp thư đến (và mục Thư rác/Spam nếu không thấy) để click vào đường link đặt lại
                    mật khẩu mới. Đường link này chỉ có hiệu lực trong vòng 15 phút.
                  </p>
                </div>
              </div>
            )}
            ...
            <div className='mt-6 pt-5 border-t border-border flex items-center justify-center'>
              <Link
                to='/login'
                className='inline-flex items-center gap-1.5 text-xs font-bold text-muted-foreground hover:text-indigo-600 transition-colors'
              >
