  ...
  return (
    <div className='relative min-h-screen flex flex-col items-center justify-center bg-muted p-6 md:p-10 overflow-hidden select-none'>
      ...
      <div className='flex w-full max-w-md flex-col gap-6 relative z-10 animate-fade-in'>
        ...
        <Link
          to='/'
          className='flex items-center gap-2.5 self-center group transition-transform duration-300 hover:scale-102'
        >
            ...
            {!token ? (
              <div className='text-center py-4 space-y-4 animate-scale-up'>
                ...
                <div className='space-y-1'>
                  ...
                  <p className='text-xs text-muted-foreground leading-relaxed'>
                    Liên kết bạn vừa truy cập không chứa token bảo mật hợp lệ hoặc đã hết hạn sử dụng. Vui lòng thực
                    hiện lại luồng yêu cầu quên mật khẩu.
                  </p>
                </div>
              ...
              <div className='text-center py-4 space-y-4 animate-scale-up'>
                ...
                <div className='space-y-1'>
                  ...
                  <p className='text-xs text-muted-foreground leading-relaxed'>
                    Mật khẩu của bạn đã được thay đổi an toàn. Hệ thống tự động chuyển hướng về trang đăng nhập sau 3
                    giây...
                  </p>
                </div>
                <Button
                  onClick={() => navigate('/login')}
                  className='w-full mt-2 font-extrabold cursor-pointer rounded-xl flex items-center justify-center gap-1.5 bg-indigo-600 hover:bg-indigo-700 text-white shadow-md shadow-indigo-600/20'
                >
                  Đăng Nhập Ngay
