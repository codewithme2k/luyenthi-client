          ...
          <div className='space-y-3 mt-6'>
            {options.map((opt) => (
              ...
              >
                ...
                <span
                  className={`text-base font-medium leading-relaxed ${answer === opt.id ? 'text-primary' : 'text-foreground'}`}
                >
                  {opt.content}
                </span>
              </div>
            ...
            {options.map((opt) => {
              ...
              return (
                ...
                >
                  ...
                  />
                  <span
                    className={`text-base font-medium leading-relaxed ${isChecked ? 'text-primary' : 'text-foreground'}`}
                  >
                    {opt.content}
                  </span>
                </div>
  ...
  return (
    <div className='glass p-5 sm:p-6 rounded-2xl border border-border animate-fade-in relative'>
      ...
      <div className='flex justify-between items-start mb-4'>
              ...
              : question.type === 'MULTIPLE_CHOICE'
                ...
                : question.type === 'TRUE_FALSE'
                  ...
                  : question.type === 'ESSAY'
                    ...
                    : 'Điền khuyết'}
            {question.score && (
              <span className='ml-3 normal-case text-primary bg-primary/10 px-2.5 py-1 rounded-md'>
                {question.score} điểm
              </span>
            )}
          </div>
        ...
        {onToggleFlag && (
          <button
            ...
            className={`flex items-center gap-2 px-3 py-1.5 rounded-lg border text-sm font-bold transition-colors cursor-pointer ${
              isFlagged
      ...
      <div className='pt-1 mb-5'>
        <h2
          className='text-lg sm:text-xl font-bold leading-relaxed text-foreground'
