    ...
    const template = [
      {
        ...
        lessons: [
          ...
          },
          {
            ...
            videoUrl: '',
            googleDocUrl:
              'https://docs.google.com/document/d/e/2PACX-1vSb-S49h9X-wLdI7F6Z4a8vF8c-2u_P2U9Hh210mB9Wd/pub?embedded=true',
        ...
        {chapters.length === 0 ? (
          <div className='text-center py-16 bg-muted/10 rounded-2xl border border-dashed border-border/60'>
            ...
            <p className='text-xs text-muted-foreground mt-1 max-w-sm mx-auto'>
              Hãy tạo chương học mới bằng nút phía dưới hoặc nhấp vào "Nạp JSON" ở góc phải để nạp nhanh toàn bộ giáo
              án!
            </p>
            <div className='mt-4'>
          ...
          <div className='bg-card w-full max-w-2xl rounded-2xl border border-border shadow-xl overflow-hidden animate-in fade-in-50 zoom-in-95 duration-200'>
            ...
            <div className='p-6 space-y-4 text-sm font-semibold'>
              <p className='text-xs text-muted-foreground leading-relaxed font-semibold'>
                Dán cấu trúc thư mục chương và bài học dưới định dạng mảng JSON mẫu. Hệ thống sẽ đồng bộ cấu trúc
                chương, bài giảng tương thích tự động.
              </p>
            ...
            <form onSubmit={handleSaveLessonModal} className='p-6 space-y-5 text-sm font-semibold'>
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
                ...
                <div className='space-y-4'>
                  ...
                  <div className='space-y-1'>
                    <label className='text-xs text-muted-foreground font-bold'>
                      Trình phát 1: YouTube Video URL (nếu có)
                    </label>
                    <Input
                  ...
                  <div className='space-y-1'>
                    <label className='text-xs text-muted-foreground font-bold'>
                      Trình phát 2: Đường dẫn nhúng Google Doc (nếu có)
                    </label>
                    <Input
                    ...
                    <p className='text-[10px] text-muted-foreground leading-normal mt-1.5 font-medium'>
                      🔑 Hướng dẫn: Mở Google Doc ➔ Tệp ➔ Chia sẻ ➔ Công bố lên web ➔ Chọn tab "Nhúng" ➔ Sao chép thuộc
                      tính <code>src</code> trong thẻ iframe.
                    </p>
                  </div>
                ...
                <div className='flex flex-col space-y-1 h-full'>
                  <label className='text-xs text-muted-foreground font-bold'>
                    Nội dung bài học (HTML / Lý thuyết bổ trợ)
                  </label>
                  <textarea
                    rows={12}
              ...
              <div className='pt-4 border-t border-border flex justify-end gap-3 mt-4'>
                ...
                <Button type='submit' className='btn-premium rounded-xl font-extrabold text-xs shadow-md'>
