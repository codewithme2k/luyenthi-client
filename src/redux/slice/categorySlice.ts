...
import { callFetchCategory, callCreateCategory, callUpdateCategory, callDeleteCategory } from '@/config/api'
import type { ICategory } from '@/types/backend'

/* =====================
   Thunk
===================== */
export const fetchCategory = createAsyncThunk('category/fetchCategory', async ({ query }: { query?: string }) => {
  const res = await callFetchCategory(query)
  return res.data
})

export const createCategory = createAsyncThunk('category/createCategory', async (category: Partial<ICategory>) => {
...
export const deleteCategory = createAsyncThunk('category/deleteCategory', async ({ id }: { id: string }) => {
