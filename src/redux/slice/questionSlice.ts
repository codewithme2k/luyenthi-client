...
/* =====================
   Thunk
 ===================== */
export const fetchQuestion = createAsyncThunk('question/fetchQuestion', async ({ query }: { query?: string }) => {
  const res = await callFetchQuestion(query)
  return res.data
})

export const createQuestion = createAsyncThunk('question/createQuestion', async (question: Partial<IQuestion>) => {
...
export const deleteQuestion = createAsyncThunk('question/deleteQuestion', async ({ id }: { id: string }) => {
