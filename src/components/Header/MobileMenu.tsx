        ...
        >
          <div className="space-y-6">
            ...
            <div className="flex justify-between items-center pb-4 border-b border-border">
              <SheetTitle className="font-extrabold font-heading text-primary text-base">
                Menu Điều Hướng
              </SheetTitle>
              <SheetDescription className="sr-only">
                Menu điều hướng di động của Luyện Thi Pro
              </SheetDescription>
              <button
                ...
                <div className={`flex items-center gap-3 p-3 rounded-xl bg-muted/40 border ${
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-xs text-muted-foreground font-semibold uppercase leading-none flex items-center gap-1.5">
                      {user.role}
                      {user?.isPremium && (
                        <span className="text-[9px] font-black text-amber-500 bg-amber-500/15 px-1 py-0.2 rounded border border-amber-500/20 leading-none">VIP</span>
                      )}
                    </p>
                    <p className={`text-sm font-bold truncate leading-snug mt-1.5 ${
