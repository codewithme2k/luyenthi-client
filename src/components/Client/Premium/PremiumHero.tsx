  ...
  return (
    <div className='relative text-center max-w-3xl mx-auto mb-16 animate-fade-in'>
      ...
      <p className='text-muted-foreground text-base md:text-lg leading-relaxed'>
        Học tập không giới hạn với hàng nghìn đề thi chất lượng cao, có lời giải chi tiết và công cụ chấm điểm AI chính
        xác nhất.
      </p>
        ...
        <div className='mt-8 glass border-primary/30 max-w-xl mx-auto p-4 rounded-2xl flex items-center gap-4 text-left shadow-lg'>
          ...
          <div>
            <h4 className='font-bold text-foreground flex items-center gap-1.5 text-base'>
              ...
              <span className='text-xs font-bold text-amber-500 bg-amber-500/10 px-2 py-0.5 rounded-md flex items-center gap-0.5'>
            ...
            <p className='text-xs text-muted-foreground'>
              ...
              <strong className='text-foreground'>
                {user.premiumUntil ? formatDate(user.premiumUntil) : 'Vô thời hạn'}
              </strong>
            </p>
          </div>
        </div>
