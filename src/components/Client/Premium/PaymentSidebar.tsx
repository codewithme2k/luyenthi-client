            ...
            <div className="space-y-2.5 text-sm p-4 rounded-2xl bg-muted/40 border border-border/50">
              ...
              <div className="flex justify-between items-center text-xs">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <button onClick={() => copyToClipboard('19035619141013')} className="text-primary hover:text-primary/80 cursor-pointer"><Copy className="w-3.5 h-3.5" /></button>
                </div>
              </div>
              ...
              <div className="flex justify-between items-start text-xs border-t border-border/30 pt-2.5 mt-2">
                ...
                <div className="text-right">
                  <div className="flex items-center gap-1 justify-end">
                    ...
                    <button onClick={() => copyToClipboard(`VIP ${selectedPlan === 'ONE_MONTH' ? '1T' : selectedPlan === 'SIX_MONTHS' ? '6T' : '1N'} ${user?.name || user?.email ? (user.name || user.email).split(' ')[0].toUpperCase() : 'USER'}`)} className="text-primary hover:text-primary/80 cursor-pointer"><Copy className="w-3.5 h-3.5" /></button>
                  </div>
