...
export const PlanOptions: React.FC<PlanOptionsProps> = ({ plans, selectedPlan, onSelectPlan, formatPrice }) => {
  return (
        ...
        return (
          ...
          >
            ...
            <div className='pt-4'>
              ...
              <p className='text-xs text-muted-foreground min-h-[48px] line-clamp-3 leading-relaxed mb-4'>
                {p.description}
              </p>
