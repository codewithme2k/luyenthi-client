  ...
  return (
    <div className='space-y-4'>
      ...
      <p className='text-sm text-muted-foreground max-w-xs leading-relaxed'>
        Nền tảng ôn thi trực tuyến thông minh hàng đầu Việt Nam. Giúp học sinh bứt phá điểm số, chinh phục mọi đề thi
        THPT, Đánh giá năng lực và các kỳ thi chuyên sâu.
      </p>
