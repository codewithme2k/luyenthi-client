      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={form.handleSubmit(onSubmit)} noValidate>
            {' '}
            {/* Thêm noValidate để Zod tự handle validate */}
            <FieldGroup>
              <div className='grid grid-cols-2 gap-4'>
                {' '}
                {/* Gom nhóm nút OAuth lại cho đẹp */}
              ...
              <Field>
                ...
                {/* TỐI ƯU: Đăng ký register với React Hook Form */}
              ...
              <Field className='mt-2'>
                {/* TỐI ƯU: Tận dụng lại Component Button của shadcn/ui thay vì thẻ button thường */}
                <Button
                  type='submit'
                  disabled={isSubmit}
