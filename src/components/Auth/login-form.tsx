      ...
      <Card className='w-full shadow-lg border border-border/80 bg-card/60 backdrop-blur-md rounded-2xl overflow-hidden'>
        <CardHeader className='space-y-1.5 pb-6 text-center'>
          ...
          <CardDescription className='text-sm font-medium'>
            Đăng nhập tài khoản của bạn để tiếp tục học tập
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <FieldGroup className='space-y-4'>
              ...
              <div className='grid grid-cols-2 gap-4'>
                <Button
                  variant='outline'
                  type='button'
                  className='w-full h-10 rounded-xl border-border/80 hover:bg-muted font-bold text-xs active:scale-98 transition-all cursor-pointer'
                >
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    viewBox='0 0 24 24'
                    className='mr-2 h-4.5 w-4.5 text-foreground'
                  >
                    <path
